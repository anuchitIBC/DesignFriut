  ...
  return (
    <View style={{flex: 1, backgroundColor: COLORS.white}}>
      ...
      <View
        ...
        <Text style={{color:COLORS.textcolorintable, fontSize:fontSizes.labelSize}}>
            {'ตรวจนับพัสดุ'}
          </Text>
        </View>
        <View style={{marginHorizontal:10,flexDirection:'row'}}>
          <View style={{flex:1}}> 
          <Text style={{color:COLORS.bglinearblue, fontSize:fontSizes.TittleSize}}>
            {'ตรวจเช็คสภาพ 2564'}
          </Text>
          </View>
          <TouchableOpacity style={{}}> 
            <IconMaterialIcons name='search' size={25} color={COLORS.bglinearblue}/>
          </TouchableOpacity>
        </View>
        <View style={{marginHorizontal:10,flexDirection:'row',marginBottom:20}}>
          ...
          <Text style={{fontWeight:'bold', color:COLORS.bglinearblue, fontSize:fontSizes.labelSize}}>
            {'Computer'}
          </Text>
          </View>
        </View>
