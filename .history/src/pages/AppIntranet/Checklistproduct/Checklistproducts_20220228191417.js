      ...
      <View
        ...
        {/* {index === 0 && ( */}
          <TouchableOpacity style={{  marginHorizontal: 5, flex:1,   flexDirection: 'row',marginBottom:10}}>
            <View style={{ width:'8%', }}>
              <Text style={{color:COLORS.bglinearblue}} >{index+1}</Text>
            </View>
            <View style={{ width:'40%', }}>
              <Text style={{color:COLORS.bglinearblue}} >{item.IDCode}</Text>
            </View>
            <View style={{ width:'30%', }}>
              <Text style={{color:COLORS.bglinearblue}} >{item.SN}</Text>
            </View>
            <View style={{ width:'15%', }}>
              <Text style={{color:COLORS.bglinearblue}} >{item.Brandname}</Text>
            </View>
            <View style={{ width:'7%', }}>
              <Text style={{color:COLORS.bglinearblue}} >{'>'}</Text>
            </View>
