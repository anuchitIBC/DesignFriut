    ...
    return (
      <View
        ...
        <TouchableOpacity
          ...
          <View style={{width: '43%'}}>
            <Text numberOfLines={2} style={{ textAlign: 'left', color: COLORS.bglinearblue}}>
              {item.IDCode}
            </Text>
          </View>
          <View style={{width: '30%'}}>
    ...
    <View style={{flex: 1, backgroundColor: COLORS.white}}>
      ...
      <View
        ...
        <View
          ...
          <View style={{width: '40%', }}>
            <Text style={{fontWeight:'bold', textAlign: 'center'}}>{'ID'}</Text>
          </View>
          <View style={{width: '30%', }}>
            <Text style={{fontWeight:'bold', textAlign: 'center'}}>{'S/N'}</Text>
          </View>
          <View style={{width: '15%', }}>
            <Text style={{fontWeight:'bold', textAlign: 'center'}}>{'Brand'}</Text>
          </View>
          <View style={{width: '7%', }}>
